...
# 4. Write a statement that uses the find function to find College in mcc_string. Print the value returned by the
# function (2 pts.).
...
# 6. Write a print statement using an f-string that prints out the following using the variables defined below.
...
# 7. Write a statement that replaces Spring 2023 with Fall 2022 in string_one and assigns it to string_two.
# Print string_two (2 pts.).
